...
WORKDIR /go/src/github.com/elcarta/evilginx2
...
COPY . /go/src/github.com/elcarta/evilginx2
...
COPY --from=build /go/src/github.com/elcarta/evilginx2/bin/evilginx /app/evilginx
